  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center ${show ? 'block' : 'hidden'} z-50`}>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg z-50 max-w-lg w-full">
        ...
        <p className="mb-4">To participate in a goal, you need to create an account by sending a transaction to the contract, it will veriy that you have a minimum of 0.01 AVAX in your wallet. This helps us prevent users from creating spam accounts.</p>
        {errorMessage && <p className="mb-4 text-red-500">{errorMessage}</p>}
        {loading && <Loader />}  {/* Loader shows when loading is true */}
