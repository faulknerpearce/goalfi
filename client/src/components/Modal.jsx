  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center ${show ? 'block' : 'hidden'} z-50`}>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg z-50 max-w-lg w-full">
        ...
        <p className="mb-4">To create an account and participate in the goal pools, we need to ensure that you have a minimum of 0.01 ETH in your wallet. This helps us prevent users from creating accounts with empty balances.</p>
