...
const GoalCard = ({ goal, joinGoal }) => {
  return (
    <div className="flex flex-col justify-between h-full white-glassmorphism p-6 m-2 cursor-pointer hover:shadow-xl rounded-lg border border-gray-700 max-w-sm w-full">
      <div>
        ...
        <div className="text-sm text-gray-300 w-full">
          ...
          <div className="relative pt-6 mb-4 w-full">
            <div className="overflow-hidden h-3 text-xs flex rounded-full bg-sky-200">
              <div style={{ width: `${(goal.currentDeposits / goal.maxCapacity) * 100}%` }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-sky-500"></div>
            </div>
          </div>
